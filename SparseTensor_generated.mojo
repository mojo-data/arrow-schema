...
struct SparseTensorIndexCOO:
    ...
    fn indicesStrides(self, i: Int) -> Int64:
        return flatbuffers.read[DType.int64](self._buf, flatbuffers.field_vector(self._buf, int(self._pos), 6) + i * 8)
...
struct SparseMatrixIndexCSX:
    ...
    fn build(
        inout builder: flatbuffers.Builder,
        *,
        compressedAxis: SparseMatrixCompressedAxis = SparseMatrixCompressedAxis(0),
...
struct SparseTensorIndexCSF:
    ...
    fn indptrBuffers(self, i: Int) -> Buffer:
        var start = flatbuffers.field_vector(self._buf, int(self._pos), 6) + i * 16
    ...
    fn indicesBuffers(self, i: Int) -> Buffer:
        var start = flatbuffers.field_vector(self._buf, int(self._pos), 10) + i * 16
        return Buffer(self._buf, start)
    ...
    fn axisOrder(self, i: Int) -> Int32:
        return flatbuffers.read[DType.int32](self._buf, flatbuffers.field_vector(self._buf, int(self._pos), 12) + i * 4)
...
struct SparseTensor:
    ...
    fn type_as_Null(self) -> Null:
        return Null(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_Int(self) -> Int_:
        return Int_(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_FloatingPoint(self) -> FloatingPoint:
        return FloatingPoint(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_Binary(self) -> Binary:
        return Binary(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_Utf8(self) -> Utf8:
        return Utf8(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_Bool(self) -> Bool_:
        return Bool_(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_Decimal(self) -> Decimal:
        return Decimal(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_Date(self) -> Date:
        return Date(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_Time(self) -> Time:
        return Time(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_Timestamp(self) -> Timestamp:
        return Timestamp(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_Interval(self) -> Interval:
        return Interval(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_List(self) -> List_:
        return List_(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_Struct_(self) -> Struct_:
        return Struct_(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_Union(self) -> Union:
        return Union(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_FixedSizeBinary(self) -> FixedSizeBinary:
        return FixedSizeBinary(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_FixedSizeList(self) -> FixedSizeList:
        return FixedSizeList(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_Map(self) -> Map:
        return Map(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_Duration(self) -> Duration:
        return Duration(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_LargeBinary(self) -> LargeBinary:
        return LargeBinary(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_LargeUtf8(self) -> LargeUtf8:
        return LargeUtf8(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_LargeList(self) -> LargeList:
        return LargeList(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_RunEndEncoded(self) -> RunEndEncoded:
        return RunEndEncoded(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_BinaryView(self) -> BinaryView:
        return BinaryView(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_Utf8View(self) -> Utf8View:
        return Utf8View(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_ListView(self) -> ListView:
        return ListView(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    fn type_as_LargeListView(self) -> LargeListView:
        return LargeListView(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 6).or_else(0))

    #  The dimensions of the tensor, optionally named.
    fn shape(self, i: Int) -> TensorDim:
        var start = flatbuffers.field_vector(self._buf, int(self._pos), 8) + i * 4
    ...
    fn sparseIndex_as_SparseTensorIndexCOO(self) -> SparseTensorIndexCOO:
        return SparseTensorIndexCOO(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 14).or_else(0))

    fn sparseIndex_as_SparseMatrixIndexCSX(self) -> SparseMatrixIndexCSX:
        return SparseMatrixIndexCSX(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 14).or_else(0))

    fn sparseIndex_as_SparseTensorIndexCSF(self) -> SparseTensorIndexCSF:
        return SparseTensorIndexCSF(self._buf, flatbuffers.field_table(self._buf, int(self._pos), 14).or_else(0))
